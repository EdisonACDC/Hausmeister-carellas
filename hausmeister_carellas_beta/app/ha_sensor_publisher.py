...
ENTITY_PREFIX = "sensor.hausmeister_carellas_beta"
REFRESH_SECONDS = 15
...
def sensor_payloads(snapshot: dict) -> dict[str, dict]:
    common = {"integration": "Hausmeister Carellas BETA", "updated_at": snapshot["updated_at"]}
    return {
        f"{ENTITY_PREFIX}_ticket_aperti": {
            "state": str(snapshot["open_count"]),
            "attributes": {
                **common,
                "friendly_name": "Hausmeister BETA · Ticket aperti",
        ...
        f"{ENTITY_PREFIX}_ticket_urgenti": {
            ...
            "attributes": {
                **common,
                "friendly_name": "Hausmeister BETA · Ticket urgenti",
        ...
        f"{ENTITY_PREFIX}_scorte_basse": {
            ...
            "attributes": {
                **common,
                "friendly_name": "Hausmeister BETA · Scorte basse",
